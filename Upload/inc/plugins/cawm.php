 ...
 $setting_4 = array(
  ...
  $setting_9 = array(
   ...
   $setting_5 = array(
	...
	border-top: 1px solid {\$mybb->settings[\'annb\']}; border-right: 1px solid {\$mybb->settings[\'annb\']}; border-left: 1px solid  {\$mybb->settings[\'annb\']}; border-bottom: 1px solid {\$mybb->settings[\'annb\']};border-radius: 6px;text-align: center; margin: 10px auto; padding: 5px 20px 5px 125px;color:{\$mybb->settings[\'anncc\']};line-height: 2em;position: relative;\"><div style=\"background: {\$mybb->settings[\'annd\']}; position: absolute; top: 0; left: 0; padding: 5px 20px; margin: -1px; line-height: 2em; font-weight: 800; color: {\$mybb->settings[\'anndc\']}; border: 1px solid {\$mybb->settings[\'anndb\']}; border-bottom-left-radius: 6px; border-top-left-radius: 6px; \">
